...
def roi_mask(gray_img):
    # region1 = np.array([[[0, 332], [242, 255], [305, 255], [402, 332]]], dtype=np.int32)
    region2 = np.array([[[44, 245], [221, 117], [303, 119], [461, 233]]], dtype=np.int32)
    mask = np.zeros_like(gray_img)
    cv2.fillPoly(mask, region2, 255)
